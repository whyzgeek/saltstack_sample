...
cluster_name: '${pillar['envs'][env]['cassandra']['cluster_name']}'
...
initial_token: ${pillar['envs'][env]['cassandra']['seeds_tokens'][grains['ip_interfaces']['eth0'][0]]}
...
data_file_directories:
    - ${pillar['db_target']}/cassandra/data

# commit log
commitlog_directory: ${pillar['db_target']}/cassandra/commitlog
...
# saved caches
saved_caches_directory: ${pillar['db_target']}/cassandra/saved_caches
...
seed_provider:
    ...
    - class_name: org.apache.cassandra.locator.SimpleSeedProvider
      parameters:
          ...
          # Ex: "<ip1>,<ip2>,<ip3>"
          - seeds: "${','.join(pillar['envs'][env]['cassandra']['seeds_tokens'].keys())}"
